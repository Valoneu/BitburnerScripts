...
export async function main(ns) {
  ...
  const corporationServers = new Set([
    "ecorp", "megacorp", "b-and-a", "blade", "nwo", "clarkinc", 
    "omnitek", "4sigma", "kuai-gong", "fulcrumassets"
  ]);
  ...
  function printServer(server, path, prefix = "", isLast = true) {
    ...
    const clickableServer = React.createElement("a", {
    ...
    ns.tprintRaw(React.createElement("span", null, branch, clickableServer));
